# #  The is the course assignment for Coursera "Getting and Cleaning Data" class.
# #  
# #  See README.md and CodeBook.md for additional information
# #  Per the instructions, this script does the following:
# # 
